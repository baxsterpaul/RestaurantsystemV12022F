    ...
    text-align: center;
	        		...
	        		<div class="box box-solid">
	        			<div class="box-header with-border">
	        				<h4 class="box-title"><i class="fa fa-calendar"></i> <b>Order : Today</b></h4><a style="float:right;" href="orderkitchenyesterday.php" class="btn btn-info" role="button">Yesterday</a>
...
$(document).ready(function(){
	$("#screen").load('ordertablekitchen.php')
