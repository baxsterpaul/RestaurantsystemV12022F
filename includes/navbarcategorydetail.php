  ...
  <nav class="navbar navbar-fixed-top">
    <div class="container">
      <div class="navbar-header">
        ...
        <a href="indexcategory.php?mode=<?= $_SESSION['ordertype'] ?>" class="navbar-brand"><b> <i class="fa fa-arrow-left"></i>&nbsp;&nbsp;<?php 
    $mode= "" ;
    if($_SESSION['ordertype'] == "dinein" ){
      ...
      echo $mode;
       ...
       ?><?php $cat = ($cat['name']) ?  ' - ' . $cat['name'] :  '';
      $cat2 =  strlen($cat) > 15 ? substr_replace($cat, "...", 15) : $cat ;
       echo $cat2; 
       ?></b></a>
      ...
      <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <?php } else {
              echo "<li><a href='orderkitchen.php'>KITCHEN</a></li>";
            }
          } ?>
          <ul class="dropdown-menu" role="menu">
            <?php
