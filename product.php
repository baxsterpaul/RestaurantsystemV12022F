...
<div class="wrapper">
	...
	<?php include 'includes/navbarproduct.php'; ?>
		            	...
		            	<div class="col-sm-6">
		            		...
		            		<form class="form-inline" id="productForm">
		            			<div class="form-group">
			            			...
			            			<button type="submit" class="btn btn-primary btn-lg btn-flat" style="width:100%;"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
			            		</div>
		            		</form>
		            	</div>
		            	<div class="col-sm-6">
